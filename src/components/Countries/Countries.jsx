...
const Countries = () => {
    ...
    return (
        <div className="mx-[5%] mt-28 lg:mt-44 mb-20">
            ...
            <h2 className="text-6xl font-bold mb-10 leading-normal"><span className="text-[#0f2454] dark:text-white">DISCOVER THE</span> <span className="text-[#2095AE]">WORLD</span> <br /><span className="text-[#0f2454] dark:text-white">WITH US</span></h2>
